<div id="widget_also_bought_products" class="s_widget_options_holder tb_cp">

  <h1 class="sm_title"><span>Also Bought Products</span></h1>
    ...
    <div class="tb_tabs tb_subpanel_tabs tbWidgetMainTabs">
      ...
      <div id="widget_settings_holder" class="tb_subpanel">
        ...
        <div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
          ...
          <h2>Edit Also Bought Products</h2>

          <?php if (count($languages) > 1): ?>
          <ul class="tb_tabs_nav clearfix">
            <?php foreach ($languages as $language): ?>
            <li class="s_language">
              <a href="#widget_also_bought_products_language_<?php echo $language['code']; ?>" title="<?php echo $language['name']; ?>">
          ...
          <div id="widget_also_bought_products_language_<?php echo $language_code; ?>" class="s_language_<?php echo $language_code; ?>">
            <div class="s_row_1">
              ...
              <p class="s_help">Enables the Also Bought Products content block for the current language.</p>
            </div>
          ...
          <?php require tb_modification($core_widgets_dir . '/_product_list_type_options.tpl'); ?>
          ...
          <fieldset>
            ...
            <div class="tb_wrap tb_gut_30">
              <div class="s_row_2 tb_col tb_1_5">
                <label>Source</label>
                <div class="s_select">
                  <select name="widget_data[filter_source]">
                    <option value="cart"   <?php if ($settings['filter_source'] == 'cart'):    ?> selected="selected"<?php endif; ?>>Cart</option>
                    <option value="product"<?php if ($settings['filter_source'] == 'product'): ?> selected="selected"<?php endif; ?>>Current Product</option>
                  </select>
                </div>
              </div>
              <div class="s_row_2 tb_col tb_1_5">
          ...
          <?php require tb_modification($core_widgets_dir . '/_product_slider_options.tpl'); ?>
          <?php require tb_modification($core_widgets_dir . '/_countdown_options.tpl'); ?>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var $container = $("#widget_also_bought_products");
