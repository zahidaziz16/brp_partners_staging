        ...
        <div class="s_row_1">
          ...
          <span class="s_select">
            <select name="widget_data[label_text]">
              <option value="flag+code"<?php if ($settings['label_text'] == 'flag+code'): ?> selected="selected"<?php endif; ?>>Flag and code</option>
              <option value="flag+name"<?php if ($settings['label_text'] == 'flag+name'): ?> selected="selected"<?php endif; ?>>Flag and name</option>
              <option value="flag"<?php      if ($settings['label_text'] == 'flag'):      ?> selected="selected"<?php endif; ?>>Flag</option>
              <option value="code"<?php      if ($settings['label_text'] == 'code'):      ?> selected="selected"<?php endif; ?>>Code</option>
              <option value="name"<?php      if ($settings['label_text'] == 'name'):      ?> selected="selected"<?php endif; ?>>Name</option>
            </select>
          </span>
        </div>
