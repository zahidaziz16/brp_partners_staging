<div id="widget_most_viewed_products" class="s_widget_options_holder tb_cp">

  <h1 class="sm_title"><span>Most Viewed Products</span></h1>
    ...
    <div class="tb_tabs tb_subpanel_tabs tbWidgetMainTabs">
      ...
      <div id="widget_settings_holder" class="tb_subpanel">
        ...
        <div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
          ...
          <h2>Edit Most Viewed Products</h2>

          <?php if (count($languages) > 1): ?>
          <ul class="tb_tabs_nav clearfix">
            <?php foreach ($languages as $language): ?>
            <li class="s_language">
              <a href="#widget_most_viewed_products_language_<?php echo $language['code']; ?>" title="<?php echo $language['name']; ?>">
          ...
          <div id="widget_most_viewed_products_language_<?php echo $language_code; ?>" class="s_language_<?php echo $language_code; ?>">
            <div class="s_row_1">
              ...
              <p class="s_help">Enables the Most Viewed Products content block for the current language.</p>
            </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var $container = $("#widget_most_viewed_products");
