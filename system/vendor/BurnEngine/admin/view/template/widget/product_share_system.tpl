          ...
          <fieldset>
            ...
            <div class="tb_wrap">
              ...
              <div class="s_row_2 tb_col tb_1_7 tb_live_row_1 tb_live_1_1">
                ...
                <input type="hidden" name="widget_data[button_facebook_share]" value="0" />
                <label class="tb_toggle"><input type="checkbox" name="widget_data[button_facebook_share]" value="1"<?php if($settings['button_facebook_share'] == '1') echo ' checked="checked"';?> /><span></span><span></span></label>
              </div>
              <div class="s_row_2 tb_col tb_1_7 tb_live_row_1 tb_live_1_1">
                <label>Twitter</label>
