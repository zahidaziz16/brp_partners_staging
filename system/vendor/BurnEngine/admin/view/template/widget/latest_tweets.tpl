      ...
      <div id="widget_settings_holder" class="tb_subpanel">
        ...
        <div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
          ...
          <ul class="tb_tabs_nav clearfix">
            ...
            <li class="s_language">
              <a href="#latest_tweets_widget_language_<?php echo $language['code']; ?>" title="<?php echo $language['name']; ?>">
          ...
          <div id="latest_tweets_widget_language_<?php echo $language_code; ?>" class="s_language_<?php echo $language_code; ?>">
