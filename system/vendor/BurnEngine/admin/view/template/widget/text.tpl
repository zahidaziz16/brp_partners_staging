        ...
        <div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
          ...
          <div id="text_widget_language_<?php echo $language_code; ?>" class="s_language_<?php echo $language_code; ?>">
            ...
            <div class="s_row_1">
              ...
              <span class="s_language_icon"><img src="<?php echo $language['url'] . $language['image']; ?>" /></span>
              <div class="s_full">
                <textarea name="widget_data[lang][<?php echo $language_code; ?>][text]" id="text_widget_text_<?php echo $language_code; ?>" cols="43" rows="12"><?php echo $settings['lang'][$language_code]['text']; ?></textarea>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
...
$(document).ready(function() {
  ...
  CKEDITOR.plugins.addExternal( 'lineutils', '<?php echo $theme_admin_javascript_relative_url; ?>ckeditor/plugins/lineutils/', 'plugin.js' );
  CKEDITOR.plugins.addExternal( 'widget',    '<?php echo $theme_admin_javascript_relative_url; ?>ckeditor/plugins/widget/',    'plugin.js' );
  CKEDITOR.plugins.addExternal( 'image2',    '<?php echo $theme_admin_javascript_relative_url; ?>ckeditor/plugins/image2/',    'plugin.js' );

  <?php foreach ($languages as $language): ?>
  CKEDITOR.replace('text_widget_text_<?php echo $language['code']; ?>', {
