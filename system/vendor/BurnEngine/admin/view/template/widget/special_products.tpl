<div id="widget_special_products" class="s_widget_options_holder tb_cp">

  <h1 class="sm_title"><span>Special Products</span></h1>
    ...
    <div class="tb_tabs tb_subpanel_tabs tbWidgetMainTabs">
      ...
      <div id="widget_settings_holder" class="tb_subpanel">
        ...
        <div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
          ...
          <h2>Edit Special Products</h2>

          <?php if (count($languages) > 1): ?>
          <ul class="tb_tabs_nav clearfix">
            <?php foreach ($languages as $language): ?>
            <li class="s_language">
              <a href="#widget_special_products_language_<?php echo $language['code']; ?>" title="<?php echo $language['name']; ?>">
          ...
          <div id="widget_special_products_language_<?php echo $language_code; ?>" class="s_language_<?php echo $language_code; ?>">
            <div class="s_row_1">
              ...
              <p class="s_help">Enables the Special Products content block for the current language.</p>
            </div>
                ...
                <div class="s_full clearfix">
                  <div class="s_select">
                    <select name="widget_data[sort_property]">
                      ...
                      <option value="ps.price"<?php if ($settings['sort_property'] == 'ps.price') echo ' selected="selected"'; ?>>Price</option>
                      <option value="rating"<?php if ($settings['sort_property'] == 'rating') echo ' selected="selected"'; ?>>Rating</option>
                      <option value="ps.date_start"<?php if ($settings['sort_property'] == 'ps.date_start') echo ' selected="selected"'; ?>>Date Start</option>
                      <option value="ps.date_end"<?php if ($settings['sort_property'] == 'ps.date_end') echo ' selected="selected"'; ?>>Date End</option>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var $container = $("#widget_special_products");
