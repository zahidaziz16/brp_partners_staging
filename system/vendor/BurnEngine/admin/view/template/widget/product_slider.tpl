<div id="widget_featured_products" class="s_widget_options_holder tb_cp">
  ...
  <h1 class="sm_title"><span>Product Slider</span></h1>
    ...
    <div class="tb_tabs tb_subpanel_tabs tbWidgetMainTabs">
      ...
      <div id="widget_settings_holder" class="tb_subpanel">
        ...
        <div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
          ...
          <input type="hidden" name="widget_data[view_mode]" value="list" />

          <?php // Slider settings ?>
          <input type="hidden" name="widget_data[slider]" value="1" />
          <input type="hidden" name="widget_data[slider_step]" value="1" />
          <input type="hidden" name="widget_data[slider_speed]" value="500" />
          <input type="hidden" name="widget_data[slider_pagination]" value="0" />
          <input type="hidden" name="widget_data[slider_nav_position]" value="top" />

          <div class="tb_wrap s_mb_30 s_pt_30 tb_gut_30">

            <fieldset class="tb_col tb_1_5">
              <legend>Style</legend>
              <div class="s_row_2">
                <label>Ratio (image/description)</label>
                <span class="clear"></span>
                <div class="s_full clearfix">
                  <div class="s_select">
                    <select name="widget_data[column_size]">
                      <option value="3"<?php if ($settings['column_size'] == '3') echo ' selected="selected"'; ?>>1/4 + 3/4</option>
                      <option value="4"<?php if ($settings['column_size'] == '4') echo ' selected="selected"'; ?>>1/3 + 2/3</option>
                      <option value="6"<?php if ($settings['column_size'] == '6') echo ' selected="selected"'; ?>>1/2 + 1/2</option>
                      <option value="8"<?php if ($settings['column_size'] == '8') echo ' selected="selected"'; ?>>2/3 + 1/3</option>
                      <option value="9"<?php if ($settings['column_size'] == '9') echo ' selected="selected"'; ?>>3/4 + 1/4</option>
                    </select>
                  </div>
                </div>
              </div>
            ...
            <fieldset class="tb_col tb_4_5">
              <legend>Slider</legend>
              <div class="s_row_2">
                <label>Autoplay interval</label>
                <input class="s_spinner" type="text" name="widget_data[slider_autoplay]" value="<?php echo $settings['slider_autoplay']; ?>" min="1000" step="100" size="7" />
          ...
          <div class="tb_wrap tb_gut_30">
            ...
            <fieldset class="tb_col tb_4_5">
              ...
              <div class="tb_wrap tb_gut_30">
                ...
                <div class="s_row_2 tb_col tb_1_4 tbSortPropertyDiv">
                ...
                <div class="s_row_2 tb_col tb_1_4 tbSortOrderDiv">
                  <label>Order</label>
                  <span class="clear"></span>
                  <div class="s_full clearfix">
                    <div class="s_select">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var $visible = $listingSettingsDiv.find("> div.tbProductsSettingsList");
