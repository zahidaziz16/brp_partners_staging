...
class Theme_ProductDiscountsSystemWidget extends Theme_SystemWidget
{
    ...
    public function onRenderWidgetContent($content)
    {
        ...
        $table_classes  = '';
        $table_classes .= $settings['style'] == 'table' ? 'table' : '';
        $table_classes .= $settings['table_condensed']  ? ' table-condensed' : '';
        $table_classes  = trim($table_classes) ? ' class="' . $table_classes . '"' : '';
