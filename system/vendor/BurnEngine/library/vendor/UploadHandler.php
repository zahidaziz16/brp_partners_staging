...
class UploadHandler
{
    ...
    protected function get_download_url($file_name, $version = null, $direct = false) {
        ...
        if (empty($version)) {
            ...
            $version_url = isset($this->options['image_versions'][$version]['upload_url']) ? $this->options['image_versions'][$version]['upload_url'] : '';
            if ($version_url) {
    ...
    protected function get_upload_data($id) {
        return isset($_FILES[$id]) ? $_FILES[$id] : '';
    }
    ...
    public function post($print_response = true) {
        ...
        $content_disposition_header = html_entity_decode($this->get_server_var('HTTP_CONTENT_DISPOSITION'), ENT_COMPAT, 'UTF-8');
