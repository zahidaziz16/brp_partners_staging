...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
		...
		if (isset($data['products'])) {
			foreach ($data['products'] as $product) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "order_product SET order_id = '" . (int)$order_id . "', product_id = '" . (int)$product['product_id'] . "', name = '" . $this->db->escape($product['name']) . "', data_source = '" . $this->db->escape($product['data_source']) . "', model = '" . $this->db->escape($product['model']) . "', matching_code = '" . $this->db->escape($product['matching_code']) . "', quantity = '" . (int)$product['quantity'] . "', price = '" . (float)$product['price'] . "', total = '" . (float)$product['total'] . "', tax = '" . (float)$product['tax'] . "', reward = '" . (int)$product['reward'] . "'");
	...
	public function editOrderUniqueID($order_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET unique_order_id = '" . $this->db->escape($data['unique_order_id']) . "', date_modified = NOW() WHERE order_id = '" . (int)$order_id . "'");
