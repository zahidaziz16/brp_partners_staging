    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="thumbnails">
            <?php if ($thumb) { ?>
            <li><a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" width="<?php echo $thumb_width;?>" height="<?php echo $thumb_height;?>" /></a></li>
            <?php } ?>
            <?php if ($images) { ?>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <div id="product">
            ...
            <?php //if($config_using_warehouse_module) { ?>
                <button type="button" data-toggle="modal" data-target="#Modal01" class="btn btn-primary btn-lg btn-block" onclick="javascript:callLoadingImg();apiCheckStock('<?php echo $config_using_warehouse_module;?>', '<?php echo $product_id;?>', '<?php echo $data_source;?>', '<?php echo $matching_code;?>');">Check Stock Levels</button>
            <?php //}
            //$product_id
            //$data_source
            //$model
			...
			function apiCheckStock(using_warehouse, product_id, data_source, matching_code){
				//matching_code = "R04-09|HPB5L24A|HPB3Q11A";
				//matching_code = "R04-09|HPB3Q11A";
				$.ajax({
					url: 'index.php?route=product/product/ajaxAPI',
					type: 'post',
					data: 'using_warehouse=' + encodeURIComponent(using_warehouse) + '&product_id=' + encodeURIComponent(product_id) + '&data_source=' + encodeURIComponent(data_source) + '&matching_code=' + encodeURIComponent(matching_code),
					dataType: 'json',
					beforeSend: function() {
					...
					success: function(json) {
						...
						if(jsonData!="") {
							...
							if(jsonData.length==1) {
								...
								$('#stock_count1').html(jsonData[0]["Bal"].replace(".0000",""));
							} else {
...
<div class="modal fade" id="Modal01" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-bodyx" style="height:200px">
                
                <br />
                
                <?php if(!$config_using_warehouse_module && ($data_source!="" && $data_source!="0")) { ?>
                    <div class="col-md-8">
                        At Principal's Warehouse
                    </div>
                    <div id="stock_count1" class="col-md-4">
                ...
                <?php } else if($config_using_warehouse_module && ($data_source!="" && $data_source!="0")) { ?>
                    ...
                    <div id="stock_count2" class="col-md-4">
                        <img src="admin/view/image/data_sync/loading.gif" />
                    </div>
