...
<div class="panel-body">
  <div class="list-group">
	...
	<a href="<?php echo $quotation; ?>" class="list-group-item"><?php echo $text_quotation; ?></a>
        <?php if($isPetronasUser && $quotationSuperAdmin) { ?>
        <a href="<?php echo $quotation_report; ?>" class="list-group-item"><?php echo $text_quotation_report; ?></a>
        <?php } ?>
