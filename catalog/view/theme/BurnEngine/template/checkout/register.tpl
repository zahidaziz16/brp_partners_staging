...
//--></script>
<script type="text/javascript"><!--
Array.prototype.forEach.call(document.getElementById('collapse-payment-address').querySelectorAll('fieldset'), function(el) {
    tbUtils.addClass(el, 'form-horizontal');
});
