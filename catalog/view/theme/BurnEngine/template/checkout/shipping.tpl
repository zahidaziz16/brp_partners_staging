<div class="panel panel-default">
  ...
  <div id="collapse-shipping" class="panel-collapse collapse">
    ...
    <form class="form-horizontal">
      ...
      <div id="shipping_quote" style="display: none;"></div>
    </form>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				html  = '<span class="clear tb_sep"></span>';
				html += '<span class="clear tb_sep border"></span>';
        ...
        html += '  <button type="submit" id="button-shipping" class="btn"><?php echo $button_shipping; ?></button>';
        <?php } else { ?>
        html += '  <button type="submit" id="button-shipping" class="btn" disabled="disabled"><?php echo $button_shipping; ?></button>';
        <?php } ?>
