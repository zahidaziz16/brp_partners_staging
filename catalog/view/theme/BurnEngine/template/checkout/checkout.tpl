...
<?php $tbData->slotStart('checkout/checkout.breadcrumbs'); ?>
<ul class="breadcrumb">
...
<?php $tbData->slotStart('checkout/checkout.page_title'); ?>
<h1><?php echo $heading_title; ?></h1>
<?php $tbData->slotStop(); ?>

<?php // Page content ------------------------------------------------- ?>

<?php $tbData->slotStart('checkout/checkout.page_content'); ?>
