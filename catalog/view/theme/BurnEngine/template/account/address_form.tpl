...
<?php $tbData->slotStartSystem('account/address/update.breadcrumbs'); ?>
<ul class="breadcrumb">
...
<?php $tbData->slotStartSystem('account/address/update.page_title'); ?>
<h1><?php echo $heading_title; ?></h1>
<?php $tbData->slotStop(); ?>

<?php // Page content ------------------------------------------------- ?>

<?php $tbData->slotStartSystem('account/address/update.page_content'); ?>
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="edit_address_form">
