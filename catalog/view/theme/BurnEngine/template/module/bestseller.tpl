...
<?php $tbData->slotStart('module/bestseller.products', array('filter' => array('module/bestseller.products.filter|oc_module_products.filter', 'products' => &$products), 'data' => $data)); ?>
<?php if ($products): ?>
