...
<?php $tbData->slotStart('affiliate/payment.breadcrumbs'); ?>
<ul class="breadcrumb">
...
<?php $tbData->slotStart('affiliate/payment.page_title'); ?>
<h1><?php echo $heading_title; ?></h1>
<?php $tbData->slotStop(); ?>

<?php // Page content ------------------------------------------------- ?>

<?php $tbData->slotStart('affiliate/payment.page_content'); ?>
