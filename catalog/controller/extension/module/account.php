...
class ControllerExtensionModuleAccount extends Controller {
	public function index() {
		...
		$data['text_quotation'] = $this->language->get('text_quotation');
                $data['text_quotation_report'] = $this->language->get('text_quotation_report');
		...
		$data['quotation'] = $this->url->link('account/quotation', '', true);
                $data['quotation_report'] = $this->url->link('account/quotation/report', '', true);
