...
class ControllerAccountOrder extends Controller {
	public function index() {
		...
		//$arrRamdom = array("Shipment", "Draft", "Pending");
		...
		$arrAPIResults = $this->model_catalog_product->coreAPI("delivery_status", $apiParams);
		...
		foreach ($results as $result) {
			...
			$data['orders'][] = array(
				...
				'delivery_status'=> (isset($arrAPIResults[$result['unique_order_id']])?$arrAPIResults[$result['unique_order_id']]:"-"),
				//'delivery_status' => $arrRamdom[rand(0,2)],
