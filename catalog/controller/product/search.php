	...
	public function index() {
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			foreach ($results as $result) {
				// BRP Customized Part
				//$result['image'] = str_replace("brp.com.my", "", $result['image']);
				if((strpos($result['image'], "brp.com.my")===false)) {
					...
					//echo "NO ".$result['image'];exit;
				} else {
					//echo "YES ".$result['image'];exit;
					$image = $this->model_tool_image->resizeBRP($result['image'], $this->config->get($this->config->get('config_theme') . '_image_product_width'), $this->config->get($this->config->get('config_theme') . '_image_product_height'));
                                        //$image = $result['image'];
				}
				//echo $image;exit;
