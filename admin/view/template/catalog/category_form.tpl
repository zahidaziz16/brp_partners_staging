          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-petronas_only"><span data-toggle="tooltip" title="Petronas Only Products"><?php echo $entry_petronas_only; ?></span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($petronas_only) { ?>
                      <input type="checkbox" name="petronas_only" value="1" checked="checked" id="input-petronas_only" />
                      <?php } else { ?>
                      <input type="checkbox" name="petronas_only" value="1" id="input-petronas_only" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
