            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <select name="filter_product_type" id="input-product_type" class="form-control">
                  <option value="*"></option>
                  <?php if (!$filter_product_type && !is_null($filter_product_type)) { ?>
                  <option value="0" selected="selected"><?php echo $entry_3rd_party; ?></option>
                  <?php } else { ?>
                  <option value="0"><?php echo $entry_3rd_party; ?></option>
                  <?php } ?>
                  <?php if ($filter_product_type) { ?>
                  <option value="1" selected="selected"><?php echo $entry_brp; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $entry_brp; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'p.quantity') { ?>
                    ...
                    <?php } else { ?>
                    <a href="<?php echo $sort_quantity; ?>"><?php echo "Quantity Available";//$column_quantity; ?></a>
                    <?php } ?></td>
                    <td class="text-right">
                    	<?php echo "At Principal's Warehouse"; ?>
                    </td>
                    <?php if($config_using_warehouse_module) { ?>
                        <td class="text-right">
                            <?php echo "At Our Warehouse"; ?>
                        </td>
                    <?php } ?>
                    
                    <td class="text-left"><?php if ($sort == 'p.data_source') { ?>
                    <a href="<?php echo $sort_product_type; ?>" class="<?php echo strtolower($order); ?>"><?php echo "Product Type"; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_product_type; ?>"><?php echo "Product Type"; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php if ($product['image']) { ?>
                    <img src="<?php echo $product['image']; ?>" alt="<?php echo $product['name']; ?>" class="img-thumbnail" width="40" height="40" />
                    <?php } else { ?>
                  ...
                  <td class="text-right"><?php if ($product['special']) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($product['quantity'] == "-" || $product['quantity'] == "") { ?>
                  ...
                  <?php } ?>
                  <td class="text-left"><?php echo ($product['data_source']==""?"Third-Party":"BRP"); ?></td>
