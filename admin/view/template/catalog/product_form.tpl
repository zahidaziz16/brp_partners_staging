        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-tax-class">Quantity Available</label>
                    <div class="col-md-10">
                      <input type="text" name="quantity" value="<?php echo $quantity; ?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control" />
                    </div>
                </div>
              <?php if(!$config_using_warehouse_module && ($data_source!="" && $data_source!="0")) { ?>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-tax-class">At Principal's Warehouse</label>
                		<div class="col-md-10 control-label" style="text-align:left;">
                            <?php echo $erp_data; ?>
                        </div>
                    </div>
              <?php } else if($config_using_warehouse_module && ($data_source!="" && $data_source!="0")) { ?>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-tax-class">At Principal's Warehouse</label>
                        <div class="col-md-10 control-label" style="text-align:left;">
                            <?php echo $erp_data; ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-tax-class">At Our Warehouse</label>
                        <div class="col-md-10 control-label" style="text-align:left;">
                            <?php echo $wms_data; ?>
                        </div>
                    </div>
              <?php } else if($config_using_warehouse_module && ($data_source=="")) { ?>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-tax-class">At Principal's Warehouse</label>
                        <div class="col-md-10 control-label" style="text-align:left;">
                            <?php echo $erp_data; ?>
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="hidden" name="subtract" value="0" id="input-subtract" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="Allow price to be updated to BRP Data Server price">Force Update Price</span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($force_update_price) { ?>
                    <input type="radio" name="force_update_price" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="force_update_price" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$force_update_price) { ?>
                    <input type="radio" name="force_update_price" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="force_update_price" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="Enable sync to Lazada Marketplace">Sync to Lazada Marketplace</span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($sync_lazada) { ?>
                    <input type="radio" name="sync_lazada" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="sync_lazada" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$sync_lazada) { ?>
                    <input type="radio" name="sync_lazada" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="sync_lazada" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
			   ...
			   <div class="form-group" style="display: none;">
                <label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="Enable sync to 11street Marketplace">Sync to 11street Marketplace</span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($sync_11street) { ?>
                    <input type="radio" name="sync_11street" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="sync_11street" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$sync_11street) { ?>
                    <input type="radio" name="sync_11street" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="sync_11street" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="Turn on serial no. for warehouse usage">Contain Serial No.</span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($contain_serialno) { ?>
                    <input type="radio" name="contain_serialno" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="contain_serialno" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$contain_serialno) { ?>
                    <input type="radio" name="contain_serialno" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="contain_serialno" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-status"><?php echo "Product Type"; ?></label>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td class="text-left">
                      <?php if($image_souce=="self" || $data_souce!="atoz") { ?>
                          <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail">
                            <img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" width="100" height="100" />
                          </a>
                      <?php } else { ?>
                          <a onclick="javascript:void(0);" id="thumb-image" class="img-thumbnail">
                            <img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" width="100" height="100" />
                          </a>
                          &nbsp;&nbsp;<font color="#FF0000">You cannot amend the images for BRP products as it comes from the centralised data server.</font>
                      <?php } ?>
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-left">
                          <?php if(!$product_image['atoz_img']) { ?>
                              <a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail">
                                <img src="<?php echo $product_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" width="100" height="100" />
                              </a>
                          <?php } else { ?>
                            <a onclick="javascript:void(0);" id="thumb-image<?php echo $image_row; ?>" class="img-thumbnail">
                            	<img src="<?php echo $product_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" width="100" height="100" />
                            </a>
                          <?php } ?>
