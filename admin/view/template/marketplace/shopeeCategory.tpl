...
$(document).ready(function() {
	...
	/*$('.select2').select2({
  ajax: {
    url: 'controller/marketplace/shopeeCategory/AjaxAPI',
	...
	$(".select2").select2({
  ajax: {
    url: "index.php?route=marketplace/shopeeCategory/AjaxAPI",
    dataType: 'json',
    delay: 250,
    data: function (params) {
      return {
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'sort_order') { ?>
                    <a><?php echo $column_shopee_category; ?></a>
                    <?php } else { ?>
                    <a><?php echo $column_shopee_category; ?></a>
                    <?php } ?></td>
                </tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right">
				  <?php //echo $shopee_selectbox; ?>
				  <select name='shopee_select_<?php echo $category['category_id']; ?>' style='width:100%;' class='select2' id='<?php echo $category['category_id']; ?>'>
				  <?php if ($category['shopee_id'] != 0){ ?>
				  <option value='<?php echo $category['shopee_id']; ?>' selected = 'selected'><?php echo $category['shopee_full_path_name']; ?></option>
				  <?php } else { ?>
				  <option value='<?php echo $category['shopee_id']; ?>' selected = 'selected'>Not Set / Disabled</option>
				  <?php }?>
				  </select>
