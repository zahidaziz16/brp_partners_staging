		...
		<?php } else { ?>
				...
				<td class="text-center">
					...
					<table style="margin: 20px auto;">
						...
						<tr>
							...
							<td class="text-left" style="padding: 5px;">
								<input type="text" value="<?php echo empty( $_POST['oc_email'] ) ? '' : $_POST['oc_email']; ?>" name="oc_email" class="form-control" style="width: 350px;" />
								<div class="help-block">E-mail from the store where you purchased this extension</div>
							</td>
						</tr>
					</table>
			...
			<tr>
				<td>
					...
					<br />
					<font style="font-weight:300; font-size: 20px;">Where I can find my Order ID in OpenCart.com store ?</font>
					<br />
					<br />
					...
					Please go to OpenCart store (<a href="https://www.opencart.com/index.php?route=account/order" target="_blank">click here</a>) &rightarrow; Account &rightarrow; Orders History (1) &rightarrow; and copy Order ID of MFP (2)
				</td>
			</tr>
		<?php } ?>
		<tr>
			<td class="text-center">
				...
				(don't forget to include your Order ID and FTP details)
			</td>
		</tr>
	</tbody>
</table>
