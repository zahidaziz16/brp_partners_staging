...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <?php } ?>
    <?php if (isset($error_setting_partner_id) && $error_setting_partner_id) { ?>
    <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $error_setting_partner_id; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
    <?php } ?>
    <?php if (isset($error_setting_partner_name) && $error_setting_partner_name) { ?>
    <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $error_setting_partner_name; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
    <?php } ?>
