                ...
                <table class="table table-bordered">
                  ...
                  <tbody id="cart">
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                         <input type="text" name="product[<?php echo $product_row; ?>][quantity]" value="<?php echo $order_product['quantity']; ?>" id="input-quantity" class="form-control" />
                      </td>
...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/quotation/api&token=<?php echo $token; ?>&api=api/qcart/products&quotation_id=' +$('input[name=\'quotation_id\']').val()+'&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		dataType: 'json',
...
$('select[name=\'currency\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=sale/quotation/api&token=<?php echo $token; ?>&api=api/currency&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-customer').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/quotation/api&token=<?php echo $token; ?>&api=api/customer&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				$.ajax({
					url: 'index.php?route=sale/quotation/api&token=<?php echo $token; ?>&api=api/qcart/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					type: 'post',
				...
				$.ajax({
					url: 'index.php?route=sale/quotation/api&token=<?php echo $token; ?>&api=api/voucher/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					type: 'post',
...
$('#tab-cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: 'index.php?route=sale/quotation/api&token=<?php echo $token; ?>&api=api/qcart/remove&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-save').on('click', function() {
	...
	if (quotation_id == 0) {
		var url = 'index.php?route=sale/quotation/api&token=<?php echo $token; ?>&api=api/quotation/add&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = 'index.php?route=sale/quotation/api&token=<?php echo $token; ?>&api=api/quotation/edit&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&quotation_id=' + quotation_id;
	}
	
	$.ajax({
		url: url,
		type: 'post',
		data: $("#tab-total select[name='quotation_status_id'], #tab-total textarea[name='comment']"),
		dataType: 'json',
		beforeSend: function() {
