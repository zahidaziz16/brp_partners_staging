            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    ...
                    <?php } ?></td>
					<td class="text-right"><?php if ($sort == 'order_no') { ?>
                    <a href="<?php echo $sort_order_no; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_order_no; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_order_no; ?>"><?php echo $column_order_no; ?></a>
                    <?php } ?></td>
                    <?php /*
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td class="text-right"><?php if($order['external_store'] == 'lazada') echo "L_"; else if($order['external_store'] == '11street') echo "11_"; else if($order['external_store'] == 'shopee') echo "S_";?><?php echo $order['order_id']; ?></td>
