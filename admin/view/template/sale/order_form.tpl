          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-total">
              ...
              <fieldset>
                ...
                <div class="form-group">
                	<label class="col-sm-2 control-label" for="input-order-status"><?php echo $entry_delivery_status; ?></label>
                    <div id="delivery_status_id" class="col-sm-10 control-label" style="text-align:left;">
                    	<?php echo $api_delivery_status; ?>
                    </div>
                </div>
                <div class="form-group">
