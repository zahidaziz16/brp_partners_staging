        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <?php // New added ?>
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $entry_using_warehouse_module; ?>"><?php echo $entry_using_warehouse_module; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_using_warehouse_module) { ?>
                        <input type="radio" name="config_using_warehouse_module" value="1" checked="checked" onclick="javascript:document.getElementById('config_unique_brp_partner_id').disabled=false;" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_using_warehouse_module" value="1" onclick="javascript:document.getElementById('config_unique_brp_partner_id').disabled=false;" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_using_warehouse_module) { ?>
                        <input type="radio" name="config_using_warehouse_module" value="0" checked="checked" onclick="javascript:document.getElementById('config_unique_brp_partner_id').disabled=true;" />
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_using_warehouse_module" value="0" onclick="javascript:document.getElementById('config_unique_brp_partner_id').disabled=true;" />
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title='This setting enables serial numbers for warehouse module. '><?php echo $entry_enable_serialno; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_enable_serialno) { ?>
                        <input type="radio" name="config_enable_serialno" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_enable_serialno" value="1" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_enable_serialno) { ?>
                        <input type="radio" name="config_enable_serialno" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_enable_serialno" value="0" />
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <?php // New added ?>
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $entry_unique_brp_partner_id; ?>"><?php echo $entry_unique_brp_partner_id; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" id="config_unique_brp_partner_id" name="config_unique_brp_partner_id" value="<?php echo $config_unique_brp_partner_id; ?>" placeholder="<?php echo $entry_unique_brp_partner_id; ?>" id="input-unique_brp_partner_id" class="form-control" <?php if (!$config_using_warehouse_module) { ?> disabled="disabled" <?php } ?> />
                    <em>Please contact BRP administrator if you want to change BRP Partner ID.</em>
                </div>
              </div>
                <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title='Auto sync all data from BRP daily at 3AM'><?php echo $entry_auto_sync_all; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_auto_sync_all) { ?>
                        <input type="radio" name="config_auto_sync_all" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_auto_sync_all" value="1" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_auto_sync_all) { ?>
                        <input type="radio" name="config_auto_sync_all" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_auto_sync_all" value="0" />
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title='This setting only affect "Auto sync all" feature. '><?php echo $entry_auto_sync_all_updateprice; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_auto_sync_all_updateprice) { ?>
                        <input type="radio" name="config_auto_sync_all_updateprice" value="1" checked="checked" id="config_auto_sync_all_updateprice_yes" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_auto_sync_all_updateprice" value="1" id="config_auto_sync_all_updateprice_yes" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_auto_sync_all_updateprice) { ?>
                        <input type="radio" name="config_auto_sync_all_updateprice" value="0" checked="checked" id="config_auto_sync_all_updateprice_no"/>
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_auto_sync_all_updateprice" value="0" id="config_auto_sync_all_updateprice_no"/>
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              </div>
              <div class="form-group" id="div_markuppercentage">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title='This setting enables Markup price feature. '><?php echo $entry_auto_sync_all_markupprice; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_auto_sync_all_markuppercentage) { ?>
                        <input type="radio" name="config_auto_sync_all_markuppercentage" id="markupPercentage_yes" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_auto_sync_all_markuppercentage" id="markupPercentage_yes" value="1" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_auto_sync_all_markuppercentage) { ?>
                        <input type="radio" name="config_auto_sync_all_markuppercentage" id="markupPercentage_no" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_auto_sync_all_markuppercentage" id="markupPercentage_no" value="0" />
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
				  <div>
					  <input type="text"  id="config_markupPercentage" name="config_markupPercentage" placeholder="Markup Percentage" value="<?php echo $config_markupPercentage;?>" style="width:140px;margin-top:5px;margin-right:3px;float:left" class="form-control" />
					  <span id="percent" style="display:block;padding-top:15px">%</span>
				  </div>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title='This setting enables Approvals for Quotations. '><?php echo $entry_enable_approval; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_enable_approval) { ?>
                        <input type="radio" name="config_enable_approval" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_enable_approval" value="1" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_enable_approval) { ?>
                        <input type="radio" name="config_enable_approval" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_enable_approval" value="0" />
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title='This setting enables Slides. '><?php echo $entry_enable_slide; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_enable_slide) { ?>
                        <input type="radio" name="config_enable_slide" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_enable_slide" value="1" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_enable_slide) { ?>
                        <input type="radio" name="config_enable_slide" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_enable_slide" value="0" />
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
			  ...
			  <!-- LAZADA !-->
			   <div class="form-group"> 
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title='This setting enables Lazada Marketplace. '><?php echo $entry_lazada_sync; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_lazada_sync) { ?>
                        <input type="radio" name="config_lazada_sync" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_lazada_sync" value="1" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_lazada_sync) { ?>
                        <input type="radio" name="config_lazada_sync" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_lazada_sync" value="0" />
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
			 ...
			 <!-- 11street !-->
			   <div class="form-group" style="display:none;"> 
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title='This setting enables 11street Marketplace. '><?php echo $entry_11street_sync; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_11street_sync) { ?>
                        <input type="radio" name="config_11street_sync" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_11street_sync" value="1" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_11street_sync) { ?>
                        <input type="radio" name="config_11street_sync" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_11street_sync" value="0" />
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
			  ...
			  <!-- Shopee !-->
			   <div class="form-group"> 
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title='This setting enables Shopee Marketplace. '><?php echo $entry_shopee_sync; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_shopee_sync) { ?>
                        <input type="radio" name="config_shopee_sync" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_shopee_sync" value="1" />
                        <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_shopee_sync) { ?>
                        <input type="radio" name="config_shopee_sync" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                    <?php } else { ?>
                        <input type="radio" name="config_shopee_sync" value="0" />
                        <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
                  ...
                  <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Types of Data to sync. EOL only applies to Products."><?php echo $entry_auto_sync_all_type; ?></span></label>
                  <div class="col-sm-10">
                      <?php foreach ($sync_tables as $keyTable => $valueTable) { ?>
                      <div class="row">
                      <div class="col-sm-3 checkbox-inline">
                        <label class="checkbox-inline"><?php  echo $valueTable; ?>
                      </div>
                      <div class="col-sm-9">
                    <?php foreach ($sync_all_types as $syncKey => $sync_all_type) { ?>
                    <?php if(($sync_all_type == "Deleted by User" && !($keyTable!="oc_banner" && $keyTable!="oc_manufacturer" && $keyTable!="oc_attribute" && $keyTable!="oc_filter" && $keyTable!="oc_customer_group" && $keyTable!="oc_zone" && $keyTable!="oc_country" && $keyTable!="oc_weight_class" && $keyTable!="oc_length_class")) || (($sync_all_type == "Modified (Price Only)" || $sync_all_type == "Modified (All)") && $keyTable!="oc_product")) { ?>
                    <?php continue; } ?>
                    <div class="checkbox-inline" <?php if(($sync_all_type == "Modified (Price Only)" || $sync_all_type == "Modified (All)") && $keyTable=="oc_product") { ?>style="margin-left:0px; padding-left:0px;"<?php } ?>>
                      <label class="checkbox-inline" <?php if(($sync_all_type == "Modified (Price Only)" || $sync_all_type == "Modified (All)") && $keyTable=="oc_product") { ?>style="margin-left:0px; padding-left:0px;"<?php } ?>>
                    <?php if(($sync_all_type == "Modified (Price Only)" || $sync_all_type == "Modified (All)") && $keyTable=="oc_product") { ?>
                         <?php if (in_array($sync_all_types_val[$syncKey], ${"config_auto_sync_all_type_".$keyTable})) { ?>
                        <input id="<?php echo $keyTable; ?><?php echo $sync_all_types_val[$syncKey]; ?>" type="radio" name="config_auto_sync_all_type_<?php echo $keyTable; ?>[]" value="<?php echo $sync_all_types_val[$syncKey]; ?>" checked="checked" />
                        <?php echo $sync_all_type; ?>
                        <?php } else { ?>
                        <input id="<?php echo $keyTable; ?><?php echo $sync_all_types_val[$syncKey]; ?>" type="radio" name="config_auto_sync_all_type_<?php echo $keyTable; ?>[]" value="<?php echo $sync_all_types_val[$syncKey]; ?>" />
                        <?php echo $sync_all_type; ?>
                        <?php } ?>
                    <?php }else { ?>
                        <?php if (in_array($sync_all_types_val[$syncKey], ${"config_auto_sync_all_type_".$keyTable})) { ?>
                        <input id="<?php echo $keyTable; ?><?php echo $sync_all_types_val[$syncKey]; ?>" type="checkbox" name="config_auto_sync_all_type_<?php echo $keyTable; ?>[]" value="<?php echo $sync_all_types_val[$syncKey]; ?>" checked="checked" />
                        <?php echo $sync_all_type; ?>
                        <?php } else { ?>
                        <input id="<?php echo $keyTable; ?><?php echo $sync_all_types_val[$syncKey]; ?>" type="checkbox" name="config_auto_sync_all_type_<?php echo $keyTable; ?>[]" value="<?php echo $sync_all_types_val[$syncKey]; ?>" />
                        <?php echo $sync_all_type; ?>
                        <?php } ?>
                    <?php } ?>
                      </label>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Unique key to link to gohoffice.com via APIs">Gohoffice.com Sync Key</span></label>
                <div class="col-sm-10">
                  <input type="text" id="config_gohoffice_sync_key" name="config_gohoffice_sync_key" value="<?php echo $config_gohoffice_sync_key; ?>" placeholder="<?php echo $config_gohoffice_sync_key; ?>" id="input-config_gohoffice_sync_key" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Gohoffice.com API URL">Gohoffice.com Sync URL</span></label>
                <div class="col-sm-10">
                  <input type="text" id="config_gohoffice_sync_url" name="config_gohoffice_sync_url" value="<?php echo $config_gohoffice_sync_url; ?>" placeholder="<?php echo $config_gohoffice_sync_url; ?>" id="input-config_gohoffice_sync_url" class="form-control" />
                </div>
              </div>
            </div>
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-gst_no">GST No.</label>
                <div class="col-sm-10">
                  <input type="text" name="config_gst_no" value="<?php echo $config_gst_no; ?>" placeholder="GST No." id="input-gst_no" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
...
$( document ).ready(function() {
    if($('#oc_product_mod').is(':checked')) {
        $('#oc_product_modall').prop('disabled', false);
        $('#oc_product_modprice').prop('disabled', false);
    }else {
        $('#oc_product_modall').prop('disabled', true);
        $('#oc_product_modprice').prop('disabled', true);
    }
    
    $('#oc_product_mod').on('change', function() {
            if(this.checked) {
                $('#oc_product_modall').prop('disabled', false);
                $('#oc_product_modprice').prop('disabled', false);
                $('#oc_product_modall').prop('checked', true);
            }else {
                $('#oc_product_modall').prop('checked', false);
                $('#oc_product_modprice').prop('checked', false);
                $('#oc_product_modall').prop('disabled', true);
                $('#oc_product_modprice').prop('disabled', true);
            }
    });
	...
	if($('#markupPercentage_no').is(':checked')){
		$('#config_markupPercentage').hide();
		$('#percent').hide();
	}
	else{
		$('#config_markupPercentage').show();
		$('#percent').show();
	}


$('#markupPercentage_yes').click(function() {
	if(this.checked){
		$('#config_markupPercentage').show();
		$('#percent').show();
	}
...
$('#markupPercentage_no').click(function() {
	if(this.checked){
		$('#config_markupPercentage').hide();
		$('#percent').hide();
	}
