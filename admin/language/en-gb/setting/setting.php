...
$_['entry_using_warehouse_module'] = 'Enable Warehousing Module?'; // New added
$_['entry_unique_brp_partner_id'] = 'BRP Partner ID'; // New added
$_['entry_lazada_sync'] = 'Enable Lazada Marketplace?'; // New added
$_['entry_11street_sync'] = 'Enable 11street Marketplace?'; // New added
$_['entry_shopee_sync'] = 'Enable Shopee Marketplace?'; // New added
$_['entry_auto_sync_all'] = 'Auto sync all data from BRP?'; // New added
$_['entry_auto_sync_all_updateprice'] = 'Force update price for Auto sync all'; // New added
$_['entry_auto_sync_all_markupprice'] = 'Markup price for Auto sync all'; // New added
$_['entry_auto_sync_all_type'] = 'Types of data to sync'; // New added
$_['entry_enable_approval'] = 'Enable Approval'; // New added
$_['entry_enable_slide'] = 'Enable Slides'; // New added
$_['entry_enable_serialno'] = 'Enable Serial No.'; // New added
$_['entry_max_3rd_party_product'] = 'Maximum 3rd Party Product'; // New added
$_['entry_theme']                  = 'Theme';
...
$_['error_max_3rd_party_product']             = 'Maximum number of 3rd party product must be set!';
