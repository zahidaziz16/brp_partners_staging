...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			//echo "<pre>";print_r($this->request->post["config_meta_title"]);echo "</pre>";exit;
			if(!isset($this->request->post["config_theme"])) {
				$this->request->post["config_theme"] = "theme_default";
			}
			//config_theme
		...
		$data['entry_using_warehouse_module'] = $this->language->get('entry_using_warehouse_module');  // New added
		$data['entry_unique_brp_partner_id'] = $this->language->get('entry_unique_brp_partner_id');  // New added
		$data['entry_lazada_sync'] = $this->language->get('entry_lazada_sync');  // New added
		$data['entry_11street_sync'] = $this->language->get('entry_11street_sync');  // New added
		$data['entry_shopee_sync'] = $this->language->get('entry_shopee_sync');  // New added
		$data['entry_auto_sync_all'] = $this->language->get('entry_auto_sync_all');  // New added
		$data['entry_auto_sync_all_updateprice'] = $this->language->get('entry_auto_sync_all_updateprice');  // New added
		$data['entry_auto_sync_all_markupprice'] = $this->language->get('entry_auto_sync_all_markupprice');  // New added
		$data['entry_auto_sync_all_type'] = $this->language->get('entry_auto_sync_all_type');  // New added
		$data['entry_enable_approval'] = $this->language->get('entry_enable_approval');  // New added
		$data['entry_enable_slide'] = $this->language->get('entry_enable_slide');  // New added
		$data['entry_enable_serialno'] = $this->language->get('entry_enable_serialno');  // New added
//                $data['entry_max_3rd_party_product'] = $this->language->get('entry_max_3rd_party_product');  // New added
...
//                if (isset($this->error['max_3rd_party_product'])) {
//			$data['error_max_3rd_party_product'] = $this->error['max_3rd_party_product'];
//		} else {
//			$data['error_max_3rd_party_product'] = '';
//		}
		...
		if (isset($this->request->post['config_name'])) {
			...
			$data['config_name'] = $this->config->get('config_name');
                ...
                if (isset($this->request->post['config_gst_no'])) {
			$data['config_gst_no'] = $this->request->post['config_gst_no'];
		} else {
			$data['config_gst_no'] = $this->config->get('config_gst_no');
		}
		...
		if (isset($this->request->post['config_using_warehouse_module'])) { // New added
			$data['config_using_warehouse_module'] = $this->request->post['config_using_warehouse_module'];
		} else {
			$data['config_using_warehouse_module'] = $this->config->get('config_using_warehouse_module');
		}
		
		if (isset($this->request->post['config_lazada_sync'])) { // New added - Lazada
			$data['config_lazada_sync'] = $this->request->post['config_lazada_sync'];
		} else {
			$data['config_lazada_sync'] = $this->config->get('config_lazada_sync');
		}
		
		if (isset($this->request->post['config_11street_sync'])) { // New added - 11street
			$data['config_11street_sync'] = $this->request->post['config_11street_sync'];
		} else {
			$data['config_11street_sync'] = $this->config->get('config_11street_sync');
		}
		
		if (isset($this->request->post['config_shopee_sync'])) { // New added - Shopee
			$data['config_shopee_sync'] = $this->request->post['config_shopee_sync'];
		} else {
			$data['config_shopee_sync'] = $this->config->get('config_shopee_sync');
		}
		
		if (isset($this->request->post['config_unique_brp_partner_id'])) { // New added
			$data['config_unique_brp_partner_id'] = $this->request->post['config_unique_brp_partner_id'];
		} else {
			$data['config_unique_brp_partner_id'] = $this->config->get('config_unique_brp_partner_id');
		}
		
		if (isset($this->request->post['config_gohoffice_sync_key'])) { // New added
			$data['config_gohoffice_sync_key'] = $this->request->post['config_gohoffice_sync_key'];
		} else {
			$data['config_gohoffice_sync_key'] = $this->config->get('config_gohoffice_sync_key');
		}
		
		if (isset($this->request->post['config_gohoffice_sync_url'])) { // New added
			$data['config_gohoffice_sync_url'] = $this->request->post['config_gohoffice_sync_url'];
		} else {
			$data['config_gohoffice_sync_url'] = $this->config->get('config_gohoffice_sync_url');
		}
                
		if (isset($this->request->post['config_auto_sync_all'])) { // New added
			$data['config_auto_sync_all'] = $this->request->post['config_auto_sync_all'];
		} else {
			$data['config_auto_sync_all'] = $this->config->get('config_auto_sync_all');
		}
                
		if (isset($this->request->post['config_auto_sync_all_updateprice'])) { // New added
			$data['config_auto_sync_all_updateprice'] = $this->request->post['config_auto_sync_all_updateprice'];
		} else {
			$data['config_auto_sync_all_updateprice'] = $this->config->get('config_auto_sync_all_updateprice');
		}

		if (isset($this->request->post['config_auto_sync_all_markuppercentage'])) { // New added
			$data['config_auto_sync_all_markuppercentage'] = $this->request->post['config_auto_sync_all_markuppercentage'];
		} else {
			$data['config_auto_sync_all_markuppercentage'] = $this->config->get('config_auto_sync_all_markuppercentage');
		}

		if (isset($this->request->post['config_markupPercentage'])) { // New added
			$data['config_markupPercentage'] = $this->request->post['config_markupPercentage'];
		} else {
			$data['config_markupPercentage'] = $this->config->get('config_markupPercentage');
		}
                
        if (isset($this->request->post['config_enable_approval'])) { // New added
			$data['config_enable_approval'] = $this->request->post['config_enable_approval'];
		} else {
			$data['config_enable_approval'] = $this->config->get('config_enable_approval');
		}

        if (isset($this->request->post['config_enable_slide'])) { // New added
			$data['config_enable_slide'] = $this->request->post['config_enable_slide'];
		} else {
			$data['config_enable_slide'] = $this->config->get('config_enable_slide');
		}
                
                if (isset($this->request->post['config_enable_serialno'])) { // New added
			$data['config_enable_serialno'] = $this->request->post['config_enable_serialno'];
		} else {
			$data['config_enable_serialno'] = $this->config->get('config_enable_serialno');
		}
                
                $data['sync_all_types'] = array("New","Modified","Modified (All)","Modified (Price Only)","EOL","Deleted by User");
                $data['sync_all_types_val'] = array("_new","_mod","_modall","_modprice","_eol","_rel");
                
                foreach ($arrSyncTables as $keyTable => $valueTable) {
                    if (isset($this->request->post['config_auto_sync_all_type_'.$keyTable])) {
                            $data['config_auto_sync_all_type_'.$keyTable] = $this->request->post['config_auto_sync_all_type_'.$keyTable];
                    } elseif ($this->config->get('config_auto_sync_all_type_'.$keyTable)) {
                            $data['config_auto_sync_all_type_'.$keyTable] = $this->config->get('config_auto_sync_all_type_'.$keyTable);
                    } else {
                            $data['config_auto_sync_all_type_'.$keyTable] = array();
                    }
                }
                
//                if (isset($this->request->post['config_max_3rd_party_product'])) {
//			$data['config_max_3rd_party_product'] = $this->request->post['config_max_3rd_party_product'];
//		} else {
//			$data['config_max_3rd_party_product'] = $this->config->get('config_max_3rd_party_product');
//		}
...
//                if (!$this->request->post['config_max_3rd_party_product']) {
//			$this->error['max_3rd_party_product'] = $this->language->get('error_max_3rd_party_product');
//		}
		...
		if (isset($this->request->post['config_ftp_status']) && $this->request->post['config_ftp_status']) {
