...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_top'] = $this->language->get('entry_top');
                $data['entry_petronas_only'] = $this->language->get('entry_petronas_only');
		...
		if (isset($this->request->post['top'])) {
			...
			$data['top'] = 0;
                ...
                if (isset($this->request->post['petronas_only'])) {
			$data['petronas_only'] = $this->request->post['petronas_only'];
		} elseif (!empty($category_info)) {
			$data['petronas_only'] = $category_info['petronas_only'];
		} else {
			$data['petronas_only'] = 0;
		}
