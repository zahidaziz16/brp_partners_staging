...
class ControllerExtensionExtension extends Controller {
	...
	public function index() {
		...
		$files = array();//glob(DIR_APPLICATION . 'controller/extension/extension/*.php', GLOB_BRACE);
//                array_push($files, DIR_APPLICATION . 'controller/extension/extension/payment.php');
                array_push($files, DIR_APPLICATION . 'controller/extension/extension/shipping.php');
